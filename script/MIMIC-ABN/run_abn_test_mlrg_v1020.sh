...
--version "${job_name}" \
--task "test" \
--ann_path "https://huggingface.co/MK-runner/MLRG/blob/main/radiology%20report/mlrg_mimic_abn_annotation_v1.1.json" \
...
--test_ckpt_path "https://huggingface.co/MK-runner/MLRG/blob/main/mimic-abn/best_model.ckpt" \
