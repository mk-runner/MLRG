...
--version "${job_name}" \
--task "finetune" \
--ann_path "https://huggingface.co/MK-runner/MLRG/blob/main/radiology%20report/mlrg_multiview_cxr_annotation_v1.1.json" \
...
--load "https://huggingface.co/MK-runner/MLRG/blob/main/mimic-cxr/finetune/best_model.ckpt" \
